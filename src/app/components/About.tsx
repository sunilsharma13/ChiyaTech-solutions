      ...
      <div ref={ref} className="w-[90%] md:w-[72%] mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <p className="max-w-xl text-lg md:text-xl text-slate-600 font-medium leading-relaxed pt-4">
                We started ChiyaTech to fix a broken industry — where founders pay premium prices for mediocre tech. We build <span className="text-slate-900 font-bold">clean, fast, and scalable</span> software.
              </p>

              <div className="flex flex-wrap gap-4 pt-4">
                  {['Next.js', 'AI/ML', 'Cloud Native'].map(tech => (
                    <span key={tech} className="text-[11px] font-black border-b-2 border-indigo-500 text-slate-900 uppercase tracking-widest">
                      {tech}
                    </span>
                  ))}
              </div>
          ...
          <div className="lg:col-span-5 space-y-4">
            {principles.map((item, i) => (
              ...
              >
                <h3 className="text-sm font-black text-indigo-600 uppercase tracking-widest mb-2 group-hover:translate-x-1 transition-transform">
                  {item.title}
                </h3>
        ...
        >
          <div className="text-center md:text-left">
            <h4 className="text-2xl md:text-3xl font-black tracking-tight uppercase">Ready to build the future?</h4>
            <p className="text-slate-400 font-medium">Stop settling for mediocre. Start your build today.</p>
          </div>
